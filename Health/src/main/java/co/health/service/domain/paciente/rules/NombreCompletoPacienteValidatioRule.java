...
public final class NombreCompletoPacienteValidatioRule implements ValidationRule<NombreCompletoPacienteDomain>{
	
private static final ValidationRule<NombreCompletoPacienteDomain> instancia = new NombreCompletoPacienteValidatioRule();
	
	public NombreCompletoPacienteValidatioRule() {
		super();
	}
