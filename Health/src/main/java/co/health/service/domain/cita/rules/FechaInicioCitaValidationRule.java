...
public class FechaInicioCitaValidationRule implements ValidationRule<Date> {
	private static final ValidationRule<Date> instancia = new FechaInicioCitaValidationRule();
	
	private FechaInicioCitaValidationRule() {
		super();
	}
