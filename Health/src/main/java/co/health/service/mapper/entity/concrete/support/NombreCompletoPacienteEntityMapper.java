...
public final class NombreCompletoPacienteEntityMapper implements EntityMapper<NombreCompletoEntity, NombreCompletoDomain> {


	private static final EntityMapper<NombreCompletoEntity, NombreCompletoDomain> instancia = new NombreCompletoPacienteEntityMapper();
	
	private NombreCompletoPacienteEntityMapper() {
		super();
	}
