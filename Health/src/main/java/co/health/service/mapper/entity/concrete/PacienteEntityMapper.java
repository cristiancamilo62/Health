...
private static final EntityMapper<PacienteEntity, PacienteDomain> instancia = new PacienteEntityMapper();
	...
	public final PacienteDomain toDomain(final PacienteEntity entity) {
		...
		return PacienteDomain.crear(entity.getId(),entity.getNumeroIdentificacion(), NombreCompletoPacienteEntityMapper.convertToDomain(entity.getNombreCompletoPaciente()),
				ContactoPacienteEntityMapper.convertToDomain(entity.getContactoPaciente()), entity.getFechaNacimiento(), null, InformacionAfiliacionPacienteEntityMapper.convertToDomain(entity.getInformacionAfiliacionPaciente()));
	}
	...
	public final PacienteEntity toEntity(final PacienteDomain domain) {
		...
		return PacienteEntity.crear(domain.getId(),domain.getNumeroIdentificacion(), NombreCompletoPacienteEntityMapper.convertToEntity(domain.getNombreCompletoPaciente()),
				ContactoPacienteEntityMapper.convertToEntity(domain.getContactoPaciente()), domain.getFechaNacimiento(), null, InformacionAfiliacionPacienteEntityMapper.convertToEntity(domain.getInformacionAfiliacionPaciente()));
	}
