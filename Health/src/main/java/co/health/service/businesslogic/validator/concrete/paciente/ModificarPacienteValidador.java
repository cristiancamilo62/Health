...
public final class ModificarPacienteValidador implements Validator<PacienteDomain>{

	
private static final Validator<PacienteDomain> instancia = new ModificarPacienteValidador();
	
	private  ModificarPacienteValidador() {
		super();
	}
