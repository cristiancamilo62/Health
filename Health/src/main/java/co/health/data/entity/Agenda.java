...
public class Agenda {
	...
	private Agenda(final UUID id, final String nombreProfesionalSalud, final String nombreServicio, final float precioServicio,
	...
	public static final Agenda crear(final UUID id, final String nombreProfesionalSalud, final String nombreServicio, final float precioServicio,
			final Date fechaInicio, final Date fechaFin) {
		return new Agenda(id, nombreProfesionalSalud, nombreServicio, precioServicio, fechaInicio, fechaFin);
	}
